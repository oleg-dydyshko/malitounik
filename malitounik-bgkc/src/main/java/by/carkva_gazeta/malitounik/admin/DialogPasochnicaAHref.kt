...
import by.carkva_gazeta.malitounik.databinding.DialogTwoEditviewDisplayBinding
...
class DialogPasochnicaAHref : DialogFragment() {
    ...
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        activity?.let {
            ...
            binding.title.text = getString(R.string.admin_set_name_link)
            ...
            binding.url.setTextColor(ContextCompat.getColor(it, R.color.colorPrimary_text))
            binding.url.setBackgroundResource(R.color.colorWhite)
