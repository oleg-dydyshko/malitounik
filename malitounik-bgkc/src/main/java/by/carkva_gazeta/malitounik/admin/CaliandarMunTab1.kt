...
class CaliandarMunTab1 : BaseFragment() {
    ...
    fun createFont(style: Int): Typeface? {
        return when (style) {
            Typeface.BOLD -> ResourcesCompat.getFont(requireActivity(), R.font.roboto_condensed_bold)
            Typeface.ITALIC -> ResourcesCompat.getFont(requireActivity(), R.font.roboto_condensed_italic)
            Typeface.BOLD_ITALIC -> ResourcesCompat.getFont(requireActivity(), R.font.roboto_condensed_bold_italic)
            else -> ResourcesCompat.getFont(requireActivity(), R.font.roboto_condensed_regular)
        }
    }
