...
import by.carkva_gazeta.malitounik.databinding.DialogImageviewDisplayBinding
...
class DialogDeliteImage : DialogFragment() {
    ...
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        activity?.let {
            ...
            builder.setPositiveButton(resources.getText(R.string.ok)) { _: DialogInterface?, _: Int -> mListener?.imageFileDelite(position) }
