...
class DialogContextMenuImage : DialogFragment() {
    ...
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        activity?.let {
            ...
            binding.title.text = getString(R.string.admin_img_sviat)
            binding.content.text = getString(R.string.image_upload)
            binding.content2.text = getString(R.string.admin_opisanne_icon)
