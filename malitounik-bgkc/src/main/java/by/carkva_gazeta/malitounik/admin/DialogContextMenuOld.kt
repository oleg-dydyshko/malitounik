...
class DialogContextMenuOld : DialogFragment() {
    ...
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        activity?.let {
            ...
            binding.content.text = getString(R.string.rename_file)
    ...
    companion object {
        fun getInstance(position: Int, name: String, isSite: Boolean): DialogContextMenuOld {
            val dialogContextMenu = DialogContextMenuOld()
            val args = Bundle()
