...
import by.carkva_gazeta.malitounik.databinding.AdminDialogImageLoadBinding
...
class DialogImageFileLoad : DialogFragment() {
    ...
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        activity?.let {
            ...
            builder.setPositiveButton(getString(R.string.save_sabytie)) { _: DialogInterface?, _: Int ->
