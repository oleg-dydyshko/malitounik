...
class SlugbovyiaTextu {
    ...
    init {
        ...
        datMinALL.add(
            SlugbovyiaTextuData(
                49, "Зыход Сьвятога Духа (Сёмуха)", "bogashlugbovya/paniadzielak_sv_ducha_viaczernia_ndz_uvieczary.html", VIACZERNIA_UVIECZARY, pasxa = true, mineia = MINEIA_KVETNAIA
            )
        )
        datMinALL.add(
            SlugbovyiaTextuData(
