...
class SlugbovyiaTextu {
    ...
    init {
        datMinALL.add(
            SlugbovyiaTextuData(
                6, "Нядзеля Тамаша (Антыпасха)", "bogashlugbovya/ndz_tamasza_viaczernia_subota.html", VIACZERNIA, pasxa = true, mineia = MINEIA_KVETNAIA
            )
        )
        datMinALL.add(
            SlugbovyiaTextuData(
        ...
        datMinALL.add(
            SlugbovyiaTextuData(
                13, "Нядзеля міраносіцаў", "bogashlugbovya/ndz_miranosicau_viaczernia_u_subotu.html", VIACZERNIA, pasxa = true, mineia = MINEIA_KVETNAIA
            )
        )
        datMinALL.add(
            SlugbovyiaTextuData(
        ...
        datMinALL.add(
            SlugbovyiaTextuData(
                20, "Нядзеля расслабленага", "bogashlugbovya/ndz_rasslablenaha_viaczernia_u_subotu_vieczaram.html", VIACZERNIA, pasxa = true, mineia = MINEIA_KVETNAIA
            )
        )
        datMinALL.add(
            SlugbovyiaTextuData(
        ...
        datMinALL.add(
            SlugbovyiaTextuData(
                23, "Палова сьвята Пяцідзясятніцы", "bogashlugbovya/palova_sviata_piacidziasiatnicy_viaczernia_u_autorak.html", VIACZERNIA, pasxa = true, mineia = MINEIA_KVETNAIA
            )
        )
        datMinALL.add(
            SlugbovyiaTextuData(
        ...
        datMinALL.add(
            SlugbovyiaTextuData(
                49, "Панядзелак Сьвятога Духа", "bogashlugbovya/paniadzielak_sv_ducha_ndz_viaczaram.html", VIACZERNIA, pasxa = true, mineia = MINEIA_KVETNAIA
            )
        )
        datMinALL.add(
            SlugbovyiaTextuData(
        ...
        datMinALL.add(
            SlugbovyiaTextuData(
                50, "Панядзелак Сьвятога Духа", "bogashlugbovya/paniadzielak_sv_ducha_viaczernia_viaczaram.html", VIACZERNIA, pasxa = true, mineia = MINEIA_KVETNAIA
            )
        )
        datMinALL.add(
            SlugbovyiaTextuData(
