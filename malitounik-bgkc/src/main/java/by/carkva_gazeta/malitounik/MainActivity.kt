...
object Settings {
    ...
    const val GET_CALIANDAR_YEAR_MIN = 2025
    const val GET_CALIANDAR_YEAR_MAX = 2028
    ...
    fun setNotifications(context: Context, notifications: Int) {
        ...
        for (i in 0..1) {
            ...
            if (notifications != 0) {
                if (c.timeInMillis < mkTime(year, monthP, dataP - 1, 19)) {
                    intent = createIntent(
                        context, context.resources.getString(R.string.S1), context.resources.getString(R.string.Sv3), mkTimeDayPosition(year, monthP, dataP)
                    ) // Абавязковае
                    val code = "1$year"
                    pIntent = PendingIntent.getBroadcast(
                        context, code.toInt(), intent, PendingIntent.FLAG_IMMUTABLE or 0
                    )
                    setAlarm(context, mkTime(year, monthP, dataP - 1, 19), pIntent)
                }
                if (c.timeInMillis < mkTime(year, monthP, dataP, timeNotification)) {
                    intent = createIntent(
                        context, context.resources.getString(R.string.S1), context.resources.getString(R.string.Sv4), mkTimeDayPosition(year, monthP, dataP)
                    ) // Абавязковае
                    val code = "2$year"
                    pIntent = PendingIntent.getBroadcast(
                        context, code.toInt(), intent, PendingIntent.FLAG_IMMUTABLE or 0
                    )
                    setAlarm(context, mkTime(year, monthP, dataP, timeNotification), pIntent)
                }
                if (c.timeInMillis < mkTime(year, Calendar.JANUARY, 5, 19)) {
                    intent = createIntent(
                        context, context.resources.getString(R.string.S2), context.resources.getString(R.string.Sv3), mkTimeDayPosition(year, Calendar.JANUARY, 6)
                    ) // Абавязковае
                    val code = "3$year"
                    pIntent = PendingIntent.getBroadcast(
                        context, code.toInt(), intent, PendingIntent.FLAG_IMMUTABLE or 0
                    )
                    setAlarm(context, mkTime(year, Calendar.JANUARY, 5, 19), pIntent)
                }
                if (c.timeInMillis < mkTime(year, Calendar.JANUARY, 6, timeNotification)) {
                    intent = createIntent(
                        context, context.resources.getString(R.string.S2), context.resources.getString(R.string.Sv4), mkTimeDayPosition(year, Calendar.JANUARY, 6)
                    ) // Абавязковае
                    val code = "4$year"
                    pIntent = PendingIntent.getBroadcast(
                        context, code.toInt(), intent, PendingIntent.FLAG_IMMUTABLE or 0
                    )
                    setAlarm(context, mkTime(year, Calendar.JANUARY, 6, timeNotification), pIntent)
                }
                val cet = Calendar.getInstance()
                cet[year, monthP] = dataP - 1
                ...
                if (c.timeInMillis < mkTime(year, Calendar.MARCH, 24, 19)) {
                    intent = createIntent(
                        context, context.resources.getString(R.string.S4), context.resources.getString(R.string.Sv3), mkTimeDayPosition(year, Calendar.MARCH, 25)
                    ) // Абавязковае
                    val code = "11$year"
                    pIntent = PendingIntent.getBroadcast(
                        context, code.toInt(), intent, PendingIntent.FLAG_IMMUTABLE or 0
                    )
                    setAlarm(context, mkTime(year, Calendar.MARCH, 24, 19), pIntent)
                }
                if (c.timeInMillis < mkTime(year, Calendar.MARCH, 25, timeNotification)) {
                    intent = createIntent(
                        context, context.resources.getString(R.string.S4), context.resources.getString(R.string.Sv4), mkTimeDayPosition(year, Calendar.MARCH, 25)
                    ) // Абавязковае
                    val code = "12$year"
                    pIntent = PendingIntent.getBroadcast(
                        context, code.toInt(), intent, PendingIntent.FLAG_IMMUTABLE or 0
                    )
                    setAlarm(context, mkTime(year, Calendar.MARCH, 25, timeNotification), pIntent)
                }
                if (c.timeInMillis < mkTime(year, Calendar.AUGUST, 14, 19)) {
                    intent = createIntent(
                        context, context.resources.getString(R.string.S9), context.resources.getString(R.string.Sv3), mkTimeDayPosition(year, Calendar.AUGUST, 15)
                    ) // Абавязковае
                    val code = "13$year"
                    pIntent = PendingIntent.getBroadcast(
                        context, code.toInt(), intent, PendingIntent.FLAG_IMMUTABLE or 0
                    )
                    setAlarm(context, mkTime(year, Calendar.AUGUST, 14, 19), pIntent)
                }
                if (c.timeInMillis < mkTime(year, Calendar.AUGUST, 15, timeNotification)) {
                    intent = createIntent(
                        context, context.resources.getString(R.string.S9), context.resources.getString(R.string.Sv4), mkTimeDayPosition(year, Calendar.AUGUST, 15)
                    ) // Абавязковае
                    val code = "14$year"
                    pIntent = PendingIntent.getBroadcast(
                        context, code.toInt(), intent, PendingIntent.FLAG_IMMUTABLE or 0
                    )
                    setAlarm(context, mkTime(year, Calendar.AUGUST, 15, timeNotification), pIntent)
                }
                if (c.timeInMillis < mkTime(year, Calendar.DECEMBER, 24, 19)) {
                    intent = createIntent(
                        context, context.resources.getString(R.string.S13), context.resources.getString(R.string.Sv3), mkTimeDayPosition(year, Calendar.DECEMBER, 25)
                    ) // Абавязковае
                    val code = "15$year"
                    pIntent = PendingIntent.getBroadcast(
                        context, code.toInt(), intent, PendingIntent.FLAG_IMMUTABLE or 0
                    )
                    setAlarm(context, mkTime(year, Calendar.DECEMBER, 24, 19), pIntent)
                }
                if (c.timeInMillis < mkTime(year, Calendar.DECEMBER, 25, timeNotification)) {
                    intent = createIntent(
                        context, context.resources.getString(R.string.S13), context.resources.getString(R.string.Sv4), mkTimeDayPosition(year, Calendar.DECEMBER, 25)
                    ) // Абавязковае
                    val code = "16$year"
                    pIntent = PendingIntent.getBroadcast(
                        context, code.toInt(), intent, PendingIntent.FLAG_IMMUTABLE or 0
                    )
                    setAlarm(context, mkTime(year, Calendar.DECEMBER, 25, timeNotification), pIntent)
                }
                if (c.timeInMillis < mkTime(year, Calendar.JUNE, 28, 19)) {
                    intent = createIntent(
                        context, context.resources.getString(R.string.S16), context.resources.getString(R.string.Sv3), mkTimeDayPosition(year, Calendar.JUNE, 29)
                    ) // Абавязковае
                    val code = "17$year"
                    pIntent = PendingIntent.getBroadcast(
                        context, code.toInt(), intent, PendingIntent.FLAG_IMMUTABLE or 0
                    )
                    setAlarm(context, mkTime(year, Calendar.JUNE, 28, 19), pIntent)
                }
                if (c.timeInMillis < mkTime(year, Calendar.JUNE, 29, timeNotification)) {
                    intent = createIntent(
                        context, context.resources.getString(R.string.S16), context.resources.getString(R.string.Sv4), mkTimeDayPosition(year, Calendar.JUNE, 29)
                    ) // Абавязковае
                    val code = "18$year"
                    pIntent = PendingIntent.getBroadcast(
                        context, code.toInt(), intent, PendingIntent.FLAG_IMMUTABLE or 0
                    )
                    setAlarm(context, mkTime(year, Calendar.JUNE, 29, timeNotification), pIntent)
                }
                if (notifications == 2) {
                    if (c.timeInMillis < mkTime(year, Calendar.FEBRUARY, Calendar.FEBRUARY, 19)) {
                        intent = createIntent(context, context.resources.getString(R.string.S3), context.resources.getString(R.string.Sv1), mkTimeDayPosition(year, Calendar.FEBRUARY, 2))
                        val code = "19$year"
                        pIntent = PendingIntent.getBroadcast(context, code.toInt(), intent, PendingIntent.FLAG_IMMUTABLE or 0)
                        setAlarm(context, mkTime(year, Calendar.FEBRUARY, 1, 19), pIntent)
                    }
                    if (c.timeInMillis < mkTime(year, Calendar.FEBRUARY, 2, timeNotification)) {
                        intent = createIntent(context, context.resources.getString(R.string.S3), context.resources.getString(R.string.Sv2), mkTimeDayPosition(year, Calendar.FEBRUARY, 2))
                        val code = "20$year"
                        pIntent = PendingIntent.getBroadcast(context, code.toInt(), intent, PendingIntent.FLAG_IMMUTABLE or 0)
                        setAlarm(context, mkTime(year, Calendar.FEBRUARY, 2, timeNotification), pIntent)
                    }
                    if (c.timeInMillis < mkTime(year, Calendar.AUGUST, 5, 19)) {
                        intent = createIntent(context, context.resources.getString(R.string.S8), context.resources.getString(R.string.Sv1), mkTimeDayPosition(year, Calendar.AUGUST, 6))
                        val code = "21$year"
                        pIntent = PendingIntent.getBroadcast(context, code.toInt(), intent, PendingIntent.FLAG_IMMUTABLE or 0)
                        setAlarm(context, mkTime(year, Calendar.AUGUST, 5, 19), pIntent)
                    }
                    if (c.timeInMillis < mkTime(year, Calendar.AUGUST, 6, timeNotification)) {
                        intent = createIntent(context, context.resources.getString(R.string.S8), context.resources.getString(R.string.Sv2), mkTimeDayPosition(year, Calendar.AUGUST, 6))
                        val code = "22$year"
                        pIntent = PendingIntent.getBroadcast(context, code.toInt(), intent, PendingIntent.FLAG_IMMUTABLE or 0)
                        setAlarm(context, mkTime(year, Calendar.AUGUST, 6, timeNotification), pIntent)
                    }
                    if (c.timeInMillis < mkTime(year, Calendar.SEPTEMBER, 7, 19)) {
                        intent = createIntent(context, context.resources.getString(R.string.S10), context.resources.getString(R.string.Sv1), mkTimeDayPosition(year, Calendar.SEPTEMBER, 8))
                        val code = "23$year"
                        pIntent = PendingIntent.getBroadcast(context, code.toInt(), intent, PendingIntent.FLAG_IMMUTABLE or 0)
                        setAlarm(context, mkTime(year, Calendar.SEPTEMBER, 7, 19), pIntent)
                    }
                    if (c.timeInMillis < mkTime(year, Calendar.SEPTEMBER, 8, timeNotification)) {
                        intent = createIntent(context, context.resources.getString(R.string.S10), context.resources.getString(R.string.Sv2), mkTimeDayPosition(year, Calendar.SEPTEMBER, 8))
                        val code = "24$year"
                        pIntent = PendingIntent.getBroadcast(context, code.toInt(), intent, PendingIntent.FLAG_IMMUTABLE or 0)
                        setAlarm(context, mkTime(year, Calendar.SEPTEMBER, 8, timeNotification), pIntent)
                    }
                    if (c.timeInMillis < mkTime(year, Calendar.SEPTEMBER, 13, 19)) {
                        intent = createIntent(context, context.resources.getString(R.string.S11), context.resources.getString(R.string.Sv1), mkTimeDayPosition(year, Calendar.SEPTEMBER, 14))
                        val code = "25$year"
                        pIntent = PendingIntent.getBroadcast(context, code.toInt(), intent, PendingIntent.FLAG_IMMUTABLE or 0)
                        setAlarm(context, mkTime(year, Calendar.SEPTEMBER, 13, 19), pIntent)
                    }
                    if (c.timeInMillis < mkTime(year, Calendar.SEPTEMBER, 14, timeNotification)) {
                        intent = createIntent(context, context.resources.getString(R.string.S11), context.resources.getString(R.string.Sv2), mkTimeDayPosition(year, Calendar.SEPTEMBER, 14))
                        val code = "26$year"
                        pIntent = PendingIntent.getBroadcast(context, code.toInt(), intent, PendingIntent.FLAG_IMMUTABLE or 0)
                        setAlarm(context, mkTime(year, Calendar.SEPTEMBER, 14, timeNotification), pIntent)
                    }
                    if (c.timeInMillis < mkTime(year, Calendar.NOVEMBER, 20, 19)) {
                        intent = createIntent(context, context.resources.getString(R.string.S12), context.resources.getString(R.string.Sv1), mkTimeDayPosition(year, Calendar.NOVEMBER, 21))
                        val code = "27$year"
                        pIntent = PendingIntent.getBroadcast(context, code.toInt(), intent, PendingIntent.FLAG_IMMUTABLE or 0)
                        setAlarm(context, mkTime(year, Calendar.NOVEMBER, 20, 19), pIntent)
                    }
                    if (c.timeInMillis < mkTime(year, Calendar.NOVEMBER, 21, timeNotification)) {
                        intent = createIntent(context, context.resources.getString(R.string.S12), context.resources.getString(R.string.Sv2), mkTimeDayPosition(year, Calendar.NOVEMBER, 21))
                        val code = "28$year"
                        pIntent = PendingIntent.getBroadcast(context, code.toInt(), intent, PendingIntent.FLAG_IMMUTABLE or 0)
                        setAlarm(context, mkTime(year, Calendar.NOVEMBER, 21, timeNotification), pIntent)
                    }
                    if (c.timeInMillis < mkTime(year, Calendar.DECEMBER, 31, 19)) {
                        intent = createIntent(context, context.resources.getString(R.string.S14), context.resources.getString(R.string.Sv1), mkTimeDayPosition(year + 1, Calendar.JANUARY, 1))
                        val code = "29$year"
                        pIntent = PendingIntent.getBroadcast(context, code.toInt(), intent, PendingIntent.FLAG_IMMUTABLE or 0)
                        setAlarm(context, mkTime(year, Calendar.DECEMBER, 31, 19), pIntent)
                    }
                    if (c.timeInMillis < mkTime(year, Calendar.JANUARY, 1, timeNotification)) {
                        intent = createIntent(context, context.resources.getString(R.string.S14), context.resources.getString(R.string.Sv2), mkTimeDayPosition(year + 1, Calendar.JANUARY, 1))
                        val code = "30$year"
                        pIntent = PendingIntent.getBroadcast(context, code.toInt(), intent, PendingIntent.FLAG_IMMUTABLE or 0)
                        setAlarm(context, mkTime(year, Calendar.JANUARY, 1, timeNotification), pIntent)
                    }
                    if (c.timeInMillis < mkTime(year, Calendar.JUNE, 23, 19)) {
                        intent = createIntent(context, context.resources.getString(R.string.S15), context.resources.getString(R.string.Sv1), mkTimeDayPosition(year, Calendar.JUNE, 24))
                        val code = "31$year"
                        pIntent = PendingIntent.getBroadcast(context, code.toInt(), intent, PendingIntent.FLAG_IMMUTABLE or 0)
                        setAlarm(context, mkTime(year, Calendar.JUNE, 23, 19), pIntent)
                    }
                    if (c.timeInMillis < mkTime(year, Calendar.JUNE, 24, timeNotification)) {
                        intent = createIntent(context, context.resources.getString(R.string.S15), context.resources.getString(R.string.Sv2), mkTimeDayPosition(year, Calendar.JUNE, 24))
                        val code = "32$year"
                        pIntent = PendingIntent.getBroadcast(context, code.toInt(), intent, PendingIntent.FLAG_IMMUTABLE or 0)
                        setAlarm(context, mkTime(year, Calendar.JUNE, 24, timeNotification), pIntent)
                    }
                    if (c.timeInMillis < mkTime(year, Calendar.AUGUST, 28, 19)) {
                        intent = createIntent(context, context.resources.getString(R.string.S17), context.resources.getString(R.string.Sv1), mkTimeDayPosition(year, Calendar.AUGUST, 29))
                        val code = "33$year"
                        pIntent = PendingIntent.getBroadcast(context, code.toInt(), intent, PendingIntent.FLAG_IMMUTABLE or 0)
                        setAlarm(context, mkTime(year, Calendar.AUGUST, 28, 19), pIntent)
                    }
                    if (c.timeInMillis < mkTime(year, Calendar.AUGUST, 29, timeNotification)) {
                        intent = createIntent(context, context.resources.getString(R.string.S17), context.resources.getString(R.string.Sv2), mkTimeDayPosition(year, Calendar.AUGUST, 29))
                        val code = "34$year"
                        pIntent = PendingIntent.getBroadcast(context, code.toInt(), intent, PendingIntent.FLAG_IMMUTABLE or 0)
                        setAlarm(context, mkTime(year, Calendar.AUGUST, 29, timeNotification), pIntent)
                    }
                    if (c.timeInMillis < mkTime(year, Calendar.SEPTEMBER, 30, 19)) {
                        intent = createIntent(context, context.resources.getString(R.string.S18), context.resources.getString(R.string.Sv1), mkTimeDayPosition(year, Calendar.OCTOBER, 1))
                        val code = "35$year"
                        pIntent = PendingIntent.getBroadcast(context, code.toInt(), intent, PendingIntent.FLAG_IMMUTABLE or 0)
                        setAlarm(context, mkTime(year, Calendar.SEPTEMBER, 30, 19), pIntent)
                    }
                    if (c.timeInMillis < mkTime(year, Calendar.OCTOBER, 1, timeNotification)) {
                        intent = createIntent(context, context.resources.getString(R.string.S18), context.resources.getString(R.string.Sv2), mkTimeDayPosition(year, Calendar.OCTOBER, 1))
                        val code = "36$year"
                        pIntent = PendingIntent.getBroadcast(context, code.toInt(), intent, PendingIntent.FLAG_IMMUTABLE or 0)
                        setAlarm(context, mkTime(year, Calendar.OCTOBER, 1, timeNotification), pIntent)
                    }
                }
            }
...
class MainActivity : ComponentActivity(), SensorEventListener, ServiceRadyjoMaryia.ServiceRadyjoMaryiaListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (!k.getBoolean("adminNotifications", false) && (k.getBoolean("admin", false) || k.getBoolean("adminOnlyNotifications", false))) {
